...
>
  ...
  <div class="">
    ...
    <div class="dropdown">
      ...
      <ul
        class="dropdown-content bg-base-300 rounded-box z-[1] p-2 shadow-2xl w-max"
      >
        {#each activationFns as activaFn}
          <li class="flex justify-between items-center w-full gap-2">
            ...
            />
            <div class="*:fill-gray *:size-4 *:stroke-gray">
              {@html activaFn.svg}
            </div>
          </li>
        {/each}
